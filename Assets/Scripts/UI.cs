...
public class UI : MonoBehaviour
{
    ...
    public Text scoreText;                  // text displayed to show the player's score
    public Text highScoreText;              // text displayed to show the player's high score
    // instance
    public static UI instance;              // Design pattern: Singleton
    ...
    public void SetWinGameText()
    {
        endText.gameObject.SetActive(true);
        endText.text = "You Win All The Games!";
        endText.color = Color.green;
    }

    public void SetPauseGameText()
    {
        endText.gameObject.SetActive(true);
        endText.text = "Game Paused!";
        endText.color = Color.yellow;
    }

    public void UnsetPauseGameText()
    {
        endText.gameObject.SetActive(false);
    }
